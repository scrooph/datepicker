...
var $dp, WdatePicker; (function() {
    ...
    A = L(); //get the wdatepicker.js`s path
    if (_.$wdate) M(A + "skin/WdatePicker.css");//add the css style
    V = X;
    if (_.$crossFrame) {
        try {
	...
	/*--------------line for end of initilize the datepicker---------------*/
	...
	//append css style of datepicker frame
    function M(A, $, B) {
